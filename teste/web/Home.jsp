    ...
    <body>
        <div id="main_container">
            <div id="header">
                ...
                <div id="logo"> <img src="images/vegetable_welcome.jpg" alt="" border="0"  /></a> </div>
            </div>
                            ...
                            <li><a class="nav" href="${logoutLink}">Logout</a><li>
                                ...
                                <li class="divider"></li> 
                                    ...
                                    <li><a class="nav" href="./login.jsp">Login</a><li>
                                        ...
                                        <li><a href="cart.jsp" class="nav">Cart</a></li>    
                                        </ul>
                                        </div>
                                        </div>
                                        <!-- end of menu tab -->
                                            ...
                                            <c:forEach items="${sessionScope.Listp}" var="p">
                                                <div class="prod_box">   
                                                    <div class="center_prod_box">
                                                        <div class="product_title"><a href="DetailController?pid=${p.productID}">${p.productName}</a></div>
                                                        <div class="product_img"><a href="DetailController?pid=${p.productID}"><img src="${p.image}" alt="" border="0" /></a></div>
                                                        <div class="prod_price"> <span class="price">${p.price}$</span></div>          
                                                        <div class="prod_quantity"><span class="quantity">Quantity:${p.quantity}</span> </div>
                                                    </div>
                                                    <form action="MainController" method="POST">
                                                        ...
                                                        <%--<button type="submit" class="shopBtn" name="action" value="AddToCart"><span class=" icon-shopping-cart"></span> Add to cart</button>--%>
